...
public class WristDefaultCommand extends Command {
  ...
  public void execute() {
      ...
      wrist.setWristRotationPosition(wrist.getWristRotationFinalTargetNativeUnits(), Constants.WRIST_ROTATION_VELOCITY, Constants.WRIST_ROTATION_ACCELERATION);
    }
    else {
      wrist.stopWristRotation();
    }
  }
