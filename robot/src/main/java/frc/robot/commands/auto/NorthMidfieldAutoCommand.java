...
public class NorthMidfieldAutoCommand extends Command {
  private static PathPlannerPath[] paths = new PathPlannerPath[]{
    PathPlannerPath.fromChoreoTrajectory("NorthMidfieldAutoBlue.1"),
    PathPlannerPath.fromChoreoTrajectory("NorthMidfieldAutoBlue.2"),
    PathPlannerPath.fromChoreoTrajectory("NorthMidfieldAutoBlue.3"),
    PathPlannerPath.fromChoreoTrajectory("NorthMidfieldAutoBlue.4"),
  };
