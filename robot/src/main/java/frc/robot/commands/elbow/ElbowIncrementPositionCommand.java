...
public class ElbowIncrementPositionCommand extends Command {
  private double _targetPosition;

  public ElbowIncrementPositionCommand() {
  ...
  public void initialize() {
    _targetPosition = Robot.ELBOW_SUBSYSTEM.incrementTargetPosition();
    System.out.println("ElbowIncrementPositionCommand: initialize");
  ...
  public void end(boolean interrupted) {
    ...
    System.out.println("ElbowIncrementPositionCommand: end" + (interrupted ? " interrupted": ""));
  }
